...
for dacFolder in folders:
    ...
    areaHisto, area, areaErr = root_utils.plot_area(x,y,"area",lower_limit=9.e-8,upper_limit=9.e-8)
    widthHisto, width, widthErr = root_utils.plot_width(x,y,"FWHM")
    peakHisto, meanPeak, peakErr = root_utils.plot_peak(x,y,"peak")
    photonHisto = ROOT.TH1D("Photon Count Histo","Photon Count Histo",1000,0,1e13)
